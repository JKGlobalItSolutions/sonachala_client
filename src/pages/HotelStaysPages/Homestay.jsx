              ...
              {[
                ...
                <div key={index} className="card flex-shrink-0" style={{ width: "300px", borderRadius: "20px", overflow: "hidden", border: "2px solid #ddd" }}>
                  <div className="position-relative">
                    ...
                    <span className="position-absolute top-0 end-0  text-white px-2 py-1 rounded-bottom-left" style={{ fontSize: "14px",backgroundColor:"#038A5E" }}>{hotel.rating}</span>
                  </div>
                  <div className="card-body text-center">
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                      ...
                      <span className="fw-bold " style={{ fontSize: "18px" ,color:"#038A5E" }}>₹{hotel.newPrice}</span>
                    </div>
                    <p className="text-muted" style={{ fontSize: "12px" }}>+₹{hotel.taxes} taxes and charges</p>
                    <button className="btn text-white btn-sm w-100" style={{ backgroundColor:"#038A5E" }}>See availability</button>
                  </div>
                </div>
              ))}
            </div>
